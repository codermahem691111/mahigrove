...
const NewsletterContactSection = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      {showFlashSale && (
        <div
          className={`bg-gradient-to-r from-red-500 to-orange-500 text-white py-3 px-4 relative overflow-hidden transition-all duration-500 ${
          ...
          >
            ...
            <div className="max-w-md mx-auto mb-12">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:from-green-700 hover:to-emerald-700 hover:scale-105 active:scale-95"
                >
                  Subscribe & Save
                </button>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
              <a
                ...
                className="inline-flex items-center px-6 py-3 bg-green-500 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-green-600 hover:scale-105 active:scale-95"
              >
              ...
              <a
                ...
                className="inline-flex items-center px-6 py-3 border-2 border-green-600 text-green-600 rounded-full hover:bg-green-600 hover:text-white transition-all duration-300 hover:scale-105 active:scale-95"
              >
          ...
          >
              ...
              <div className="space-y-3">
                {languages.map((lang) => (
                  <button
                    ...
                    className={`
                      w-full flex items-center justify-between p-3 rounded-lg border-2 transition-all duration-200 hover:scale-102
            ...
            <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl p-6 text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                <button className="w-full bg-white text-purple-600 font-semibold py-3 px-4 rounded-lg hover:bg-purple-50 transition-all duration-300 hover:scale-105 active:scale-95">
                  Become a Partner
                </button>
              </div>
